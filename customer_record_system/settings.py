"""
Django settings for customer_record_system project.
...
SECRET_KEY = 'django-insecure-s12v6xazs+#6jx1+xz7j3lqaup&z_7vs=m2cub&a9slwki8axy'
...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    'customer-record-system.onrender.com',
    ]
...
WSGI_APPLICATION = 'customer_record_system.wsgi.application'
...
#          default='postgresql://postgres:postgres@localhost:5432/customer_record_system',        
#          conn_max_age=600 )}
